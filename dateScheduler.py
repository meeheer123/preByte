...
def schedule_interviews(candidate_data, start_time, end_time, interview_duration, break_duration):
    ...
    while candidate_data:
        ...
        available_slots = []
        while current_datetime + interview_duration + break_duration <= datetime.datetime.combine(current_date, end_time):
...
scheduled_interviews = schedule_interviews(candidate_data, start_time, end_time, interview_duration, break_duration)
